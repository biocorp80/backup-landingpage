      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20" data-aos="fade-up">
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight">
            Standard Kualitas <span className="text-teal-600">Terbaik Kami.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 transform transition hover:-translate-y-2" data-aos="fade-up" data-aos-delay="0">
            <div className="w-16 h-16 bg-teal-100 rounded-2xl flex items-center justify-center text-teal-600 mb-8 text-2xl shadow-inner">
              <UserCheck size={32} />
            </div>
          ...
          <div className="bg-white p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100 transform transition hover:-translate-y-2" data-aos="fade-up" data-aos-delay="100">
            <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center text-blue-600 mb-8 text-2xl shadow-inner">
              <ScrollText size={32} />
            </div>
