    ...
    <section className="py-16 md:py-24 bg-slate-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16" data-aos="fade-up">
          <span className="text-teal-600 font-black tracking-widest uppercase text-xs mb-2 block">CONTOH HASIL NYATA</span>
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight">
            Intip Daleman <span className="text-teal-600">Generator Judul.</span>
          </h2>
          ...
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100 flex flex-col" data-aos="fade-left">
            <div className="relative h-[400px] bg-slate-100 border-b border-slate-200">
              ...
              <div className="lg:hidden w-full h-full flex flex-col items-center justify-center bg-slate-50 p-6 text-center">
                ...
                <a href="/template-preview.pdf" target="_blank" rel="noopener noreferrer" className="bg-teal-600 text-white px-6 py-3 rounded-xl font-bold text-sm shadow-lg hover:bg-teal-700 transition flex items-center gap-2">
