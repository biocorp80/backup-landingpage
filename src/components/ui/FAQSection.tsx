    ...
    <section id="faq" className="py-16 md:py-32 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20" data-aos="fade-up">
          ...
          <div className="w-16 h-1.5 bg-gradient-to-r from-blue-400 to-teal-500 mx-auto rounded-full"></div>
        </div>
        ...
        <div className="space-y-6">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="border border-slate-200 rounded-3xl overflow-hidden transition-all duration-300 hover:shadow-xl hover:border-teal-500/30 shadow-sm"
              data-aos="fade-up"
            >
              <button
              ...
              >
                ...
                <div
                  className={clsx(
                    "w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-teal-600 transition-transform duration-500 flex-shrink-0",
                    active === index && "rotate-180 bg-teal-500 text-white"
                  )}
                >
                  <ChevronDown size={16} />
                </div>
