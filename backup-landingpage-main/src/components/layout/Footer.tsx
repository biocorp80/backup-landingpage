        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div className="col-span-1 lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <img src="/logo.png" alt="Dosbing.ai Footer Logo" className="h-10 w-auto" />
          ...
          <div>
            <h5 className="text-sm font-black uppercase tracking-widest text-secondary mb-8">Informasi</h5>
          ...
          <div>
            <h5 className="text-sm font-black uppercase tracking-widest text-secondary mb-8">Kontak Kami</h5>
            <ul className="space-y-4 text-slate-400 text-sm font-medium">
              <li className="flex items-center gap-3"><Mail className="text-primary w-4 h-4" /> dosbingai@gmail.com</li>
              <li className="flex items-start gap-3 leading-relaxed"><MapPin className="text-primary w-4 h-4 mt-1" /> Cipinang, Cimaung, Kab. Bandung, Jawa Barat</li>
            </ul>
          </div>
        </div>
