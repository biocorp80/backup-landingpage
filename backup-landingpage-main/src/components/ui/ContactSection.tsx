    ...
    <section id="contact" className="py-12 md:py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <div className="h-1.5 w-24 bg-gradient-to-r from-secondary to-primary mx-auto rounded-full mb-6"></div>
          <p className="text-slate-500 font-medium max-w-2xl mx-auto leading-relaxed text-lg">
            Punya pertanyaan seputar produk atau butuh bantuan teknis? Tim support kami siap membantu Anda.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6" data-aos="fade-right">
            {/* WhatsApp Card */}
            <a href="https://wa.me/6282118709218" target="_blank" rel="noopener noreferrer" className="flex items-center gap-6 bg-white p-6 rounded-3xl border border-slate-100 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1 group">
              ...
              <div>
                ...
                <p className="text-green-600 font-bold text-lg group-hover:underline">+62 821-1187-09218</p>
              </div>
            </a>
