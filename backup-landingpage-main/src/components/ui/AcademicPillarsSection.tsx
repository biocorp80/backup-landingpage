    ...
    <section className="py-16 md:py-24 bg-slate-50 relative overflow-hidden border-y border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16" data-aos="fade-up">
          <span className="text-secondary font-black tracking-widest uppercase text-xs mb-2 block">STANDAR KUALITAS</span>
          <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 tracking-tight">
            Telaah Akademik <span className="text-primary">4 Pilar.</span>
          </h2>
          <p className="text-slate-500 font-medium max-w-2xl mx-auto text-lg">
            Sistem AI akan memberikan skor dan analisis mendalam pada empat aspek krusial.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100 hover:-translate-y-1 transition-transform duration-300 h-full" data-aos="fade-up" data-aos-delay="100">
            <div className="w-14 h-14 bg-blue-100 text-primary rounded-2xl flex items-center justify-center mb-6 shadow-sm">
              <Lightbulb size={28} />
            </div>
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-10">
              ...
              <div className="flex flex-col items-center text-center group hover:-translate-y-1 transition-transform">
                <div className="w-16 h-16 bg-slate-100 text-slate-700 group-hover:bg-primary/10 group-hover:text-primary rounded-full flex items-center justify-center mb-4 transition-colors">
                  <TrendingUp size={24} />
                </div>
